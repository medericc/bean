    ...
    sections: [
      ...
      },
      {
        ...
        contenu: (
          <div className="space-y-4 font-corps text-gray-700 leading-relaxed">
            <p>
  Depuis 2000 ans, l’Église tranche les erreurs par ses décisions (comme l'institution des diacres dans Actes 6, le célibat des prêtres en 306, la Bible à la fin du IVe siècle) et ses conciles (du premier à Jérusalem dans Actes 15 vers l’an 50 jusqu'à Vatican II en 1965). Malgré les infiltrations historiques — de Judas aux hommes dénoncés par Saint Pie X qui feignent la foi pour tromper les simples, en passant par le Père de l'Église Saint Irénée visant ceux qui prêchent un autre Christ, un autre Père de l'Église Saint Cyrille avertissant contre les ministres divisant la foi par calculs séculiers ou les abbés de la Révolution ou encore au XXe siècle, l'archevêque Marcinkus (directeur de la banque du Vatican) impliqué dans le scandale P2 via le maçon Calvi. Elle ne se contredit jamais malgré la grande densité des conciles qui s'appuient sur les Pères de l’Église – gardiens des enseignements du Christ pour distinguer la vraie doctrine des hérésies (telles que la gnose dès les Actes avec Simon le Magicien, l’islam avec Mahomet, le mormonisme avec Smith, ou le donatisme face à un Constantin soucieux de préserver la paix) – et à l’instar de l’hérésie de la double prédestination de Calvin (où Dieu, tel le centre d'une sphère, embrasse du regard tous nos chemins et connaît nos choix sans jamais nous y contraindre) basée sur la Bible (méthodologie inversée). Il nous incombe de travailler au salut du plus grand nombre, quel que soit le contexte. Pour ce faire, nous devons suivre le phare qu’est l’Église divino-humaine, assurément faible par ses membres, mais dont la foi demeure inébranlable par le sang du Crucifié et sa prière pour le Pape. Une foi à ne pas pervertir au gré de prétextes sophistiques. À ce compte, l'un pourrait rebaptiser Marianne "Jules" sous prétexte que les révolutionnaires se référaient à la République romaine ; un autre, décréter qu'il faut chanter La Parisienne plutôt que La Marseillaise parce que la capitale est Paris ; un troisième combinerait les deux pour créer "Le Jules et la Parisienne". On se retrouverait alors avec trois entités protestantes.
