    ...
    sections: [
      {
        ...
        contenu: (
          <div className="space-y-4 font-corps text-gray-700 leading-relaxed">
            <p>
Princesse burgonde née vers 475 à Lyon, Clotilde voit ses parents et ses frères tués par son oncle Gondebaud, qui s'empare alors du pouvoir sans la faire tuer en raison de son sexe. Remarquée par Clovis, roi des Francs, elle l’épouse vers 492. Chrétienne fervente, elle cherche sans relâche à convertir son époux païen. Après la mort de leur premier enfant survenue juste après son baptême — Clotilde est contente car il meurt baptisé et sans péché —, elle persévère dans la prière. En 496, lors de la bataille de Tolbiac, Clovis invoque le Christ, remporte la victoire et se fait baptiser. Sous l'impulsion de Clovis, les territoires de la Gaule sont réunis, marquant ainsi la naissance du Royaume chrétien des Francs, et donc de la France. Sans primauté de l'aîné, elle aurait préféré voir ses fils égorgés que déshonorés. L’infanticide sera condamné chez les Francs, alors qu'il était courant auparavant (à une époque où la femme devait travailler et le mari guerroyer). Cette condamnation est restée en vigueur jusqu’à la Ve République. C'est l'évolution d'un peuple qui, comme tous les autres à l’exception des Juifs, s’est détaché de Dieu. Dans ces autres cultures, l’homme se fait Dieu, à l'image de Prométhée et Zeus, ou du serpent adoré à travers des sacrifices d’enfants chez les Amérindiens. Cette influence se perpétue ensuite en Europe via des sectes gnostiques et ésotériques. Selon ces croyances, inspirées de la gnose de Simon le Magicien, le serpent serait l'envoyé du vrai Dieu, et l'humanité chercherait à s'extirper de ce monde, possiblement en provoquant la divinité par des péchés contre nature, tels que la contraception ou l’androgynie de « Comenius ».
    ...
    sections: [
     ...
     
      {
        ...
        contenu: (
          <div className="space-y-4 font-corps text-gray-700 leading-relaxed">
            <p>
  À l'âge de onze ans, Catherine de Médicis voit des républicains florentins vouloir attenter à sa vie. Elle prend alors le voile dans un couvent, ce qui lui sauve la vie. Issue d'une célèbre famille de banquiers dont certains membres deviennent papes (qui féliciteront Marguerite de Navarre, alors protectrice des hérétiques, mais par la prière du Christ à Pierre, excommunient l’hérétique Luther), Catherine monte très bien à cheval, aime la pêche à la carpe ainsi que la chasse au sanglier, au cerf et à l’ours. Elle est profondément amoureuse de son mari, le roi Henri II. Après la mort de ce dernier, la reine se vêtira toujours de noir en signe de deuil perpétuel. Ses enfants craignent beaucoup Catherine, qui les protège avec ferveur. Pendant le siège de Rouen, en tant que reine-mère et en vertu du quatrième commandement, elle s'impose comme la seule dirigeante légitime au nom de la France et n'hésite pas à se promener jusque sous les tirs de canons face aux troupes protestantes. Cependant, sa politique de tolérance et de compromis vaut à la France de traverser huit guerres civiles en l'espace de trente ans, contrairement à l’Espagne sous le régime de l’Inquisition qui n'en connaît aucune durant plusieurs siècles (la guerre d’Espagne n'éclatant qu'après l’abolition définitive de celle-ci par les ésotéristes). Nonobstant cela, sous le gouvernement de Catherine, la France impose la peine de mort aux avorteuses, protégeant ainsi ses sujets les plus faibles dès le sein maternel.
